...
const AUTHORED: AuthoredNode[] = [
  ...
  { id: "topos", label: "topos", type: "project", color: "terracotta", r: 26, x: 1050, y: 934,
    points: [
      ...
      "Stage 0 executed on strawberry, with consensus, stability and embedding analyses committed",
    ],
  ...
  { id: "indicium", label: "indicium", type: "project", color: "blush", r: 17, x: 300, y: 1080,
    points: [
      ...
      "Built on this portfolio's own frameworks as a stack; hypotheses and a Stage 0 spec are written, no analysis has run",
    ],
